...
import { AcceptFeedMemberInviteRequest, AcceptFeedMemberInviteResponse, DeleteFeedResponse, GetOrCreateFeedRequest, GetOrCreateFeedResponse, MarkActivityRequest, PinActivityRequest, PinActivityResponse, QueryFeedMembersRequest, QueryFeedMembersResponse, QueryPinnedActivitiesRequest, QueryPinnedActivitiesResponse, RejectFeedMemberInviteRequest, RejectFeedMemberInviteResponse, Response, UnpinActivityResponse, UpdateFeedMembersRequest, UpdateFeedMembersResponse, UpdateFeedRequest, UpdateFeedResponse } from '../models';
export declare class FeedApi {
    ...
    queryPinnedActivities(request?: QueryPinnedActivitiesRequest): Promise<StreamResponse<QueryPinnedActivitiesResponse>>;
}
